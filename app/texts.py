texto_de_entrada = """
Você atravessa as portas gigantescas do Salão Principal e é imediatamente tomado por uma sensação de encanto
O teto, enfeitiçado para refletir o céu noturno, brilha com estrelas que parecem tão próximas que você quase pode tocá-las.
Velas flutuam suavemente pelo ar, iluminando o salão com uma luz quente e mágica.
À sua frente, centenas de estudantes espalhados pelas mesas das Casas olham curiosos enquanto você caminha hesitante até o centro. 
O Chapéu Seletor, velho e surrado, repousa sobre um banquinho solitário, esperando por você. O silêncio cresce. 
Sua aventura em Hogwarts está prestes a começar.
"""

texto_pos_selecao = """
A cerimônia de seleção terminou, e agora você se encontra no Grande Salão, saboreando sua primeira refeição como um estudante de Hogwarts.
O som das conversas e risadas dos outros alunos preenche o ambiente, e você sente a excitação do início dessa nova jornada. 
À medida que se acomoda à sua nova casa, começa a fazer amizades com seus colegas.
De repente, uma conversa ao seu lado chama sua atenção. 
Um estudante de Corvinal, com um olhar intrigado, sussurra para um amigo: 
"Você ouviu falar sobre o artefato? Aquele que os fundadores criaram para proteger Hogwarts... dizem que foi perdido há séculos, mas que ainda há quem o procure." 
O murmúrio é rápido, mas a ideia de algo tão poderoso, tão antigo, o deixa com uma sensação estranha. 
Algo te diz que esse artefato, perdido no tempo, tem mais a ver com você do que imagina.
"""

texto_inicial_sobre_o_artefato = """
Enquanto você digere a informação, a conversa ao seu redor começa a ficar mais abafada, até que o som do diretor se levantando preenche o salão. 
Todos os olhares se voltam para ele. "A noite está avançando, meus jovens bruxos", ele diz com um sorriso acolhedor, mas com um tom de autoridade. 
"É hora de se retirarem para seus dormitórios. Amanhã será um novo dia cheio de descobertas.\n"

O murmúrio entre os alunos cresce, mas logo o Grande Salão começa a se esvaziar, com cada casa se dirigindo para suas respectivas torres. 
No caminho para o dormitório, você percebe mais sussurros sobre o artefato — como se a menção dele tivesse despertado uma curiosidade em todos. 
Algo no ar, uma energia estranha, faz você se perguntar: será que há algo mais por trás dessas histórias?
Enquanto caminha pelos corredores, você cruza com um estudante mais velho, Alistair Blackwood, que parece notar seu olhar pensativo. 
"Ouvi sua conversa mais cedo... Sobre o artefato?" Ele faz uma pausa, olhando ao redor antes de se aproximar com um sorriso misterioso. 
"Não é algo fácil de se ignorar, eu sei. Mas cuidado com o que pergunta. A busca por ele não é um caminho simples.\n"

Intrigado, você decide procurar Alistair novamente no dormitório. Lá, com o ambiente mais calmo, você o encontra e pergunta diretamente sobre o que sabe. 
Ele hesita por um momento, como se ponderando suas palavras, antes de começar a explicar. 
"O artefato não é apenas uma lenda. Criado pelos fundadores de Hogwarts, ele tem o poder de proteger a escola... ou destruir tudo o que conhecemos. 
Há muitos que buscam seu poder, mas nem todos são dignos de controlá-lo. E o mais perigoso, é que ele pode escolher quem o controla." 
