...
(1,3,'Segundo andar do castelo','wdfqwdw');
...
(3, 2, 'Patio exterior', 2, 1, 1, 1, 'Um amplo pátio de pedras envelhecidas pelo tempo, onde alunos se reúnem para socializar e praticar duelos amistosos sob o céu aberto. Está rodeado por jardins mágicos que florescem mesmo no inverno.'),
...
(5, 1, 'Clareira', 1, 6, 1, 1, 'Uma clareira encantadora no coração da floresta, banhada pela luz da lua. As árvores ao redor formam um círculo natural, oferecendo um refúgio tranquilo para meditações ou feitiços secretos.'),
(6, 1, 'Torre leste', 5, 1, 22, 23, 'Uma torre elevada com janelas estreitas, usada por estudiosos para observações astronômicas. A vista do topo oferece um panorama deslumbrante dos terrenos da escola.'),
(7, 1, 'Torre oeste', 1, 5, 20, 21, 'A torre oeste, conhecida por ser o lar de corujas mensageiras, ecoa com o som suave de asas batendo durante a madrugada.'),
...
(9, 1, 'Refeitorio', 1, 13, 1, 1, 'Uma sala ampla com mesas de carvalho robustas, onde refeições suntuosas aparecem magicamente. O aroma de pratos deliciosos enche o ar.'),
...
(12, 1, 'Sala de Defesa Contra as Artes das Trevas:', NULL, NULL, NULL,33, 'Uma sala cheia de escuridão latente, com paredes cobertas por retratos de bruxos defensores. Criaturas mágicas embalsamadas decoram o ambiente.'),
(13, 1, 'Sala de Poções', NULL, NULL, 33, NULL, 'Um ambiente sombrio com caldeirões borbulhantes e prateleiras carregadas de ingredientes misteriosos. O cheiro de ervas e líquidos pungentes preenche o ar.'),
(14, 1, 'Sala de Herbologia', NULL, NULL, NULL, 34, 'Uma estufa iluminada com plantas exóticas que se movem e murmuram. Alunos estudam botânica mágica com cuidado para evitar mordidas acidentais.'),
(15, 1, 'Dormitório: Grifinória', 1, 1, 1, 12, 'Um dormitório acolhedor com tapeçarias vermelhas e douradas, decorado com brasões da casa Grifinória. A lareira central mantém o local sempre aquecido.'),
(16, 1, 'Dormitório: Cornival', 1, 1, 12, 1, 'Um dormitório elegante com detalhes em azul e prateado. O teto reflete o céu noturno, proporcionando uma visão das estrelas.'),
(17, 1, 'Dormitório: Sonserina', 1, 1, 1, 11, 'Um dormitório subterrâneo com paredes de pedra e luzes verdes etéreas. A atmosfera é fria, mas repleta de mistério.'),
(18, 1, 'Dormitório: Lufa-lufa', 1, 1, 11, 1, 'Um dormitório aconchegante com cores quentes e móveis de madeira. Plantas mágicas decoram o espaço, trazendo vida e serenidade.'),
(19, 2, 'Floresta Negra', 2, 7, 14, 2, 'Uma floresta densa e perigosa, habitada por criaturas encantadas e segredos ancestrais. Caminhar por suas trilhas exige coragem e astúcia.'),
(20, 2, 'Campo de Quadribol', 3, 6, 12, 3, 'Um campo vasto com arquibancadas altas. As balizas se erguem como sentinelas, prontas para testemunhar intensas partidas de quadribol.'),
...
(31,3, 'Corredor das Runas Antigas', NULL, 34, 36, 37, 'Repleto de marcas e inscrições arcanas nas paredes, este corredor ressoa com uma energia ancestral. Runa a runa, ele ensina lições aos estudantes atentos enquanto os distraídos podem sentir leves arrepios.'),
