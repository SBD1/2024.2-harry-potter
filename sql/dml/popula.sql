...
(5, 1, 'Ponte Exterior', NULL, 40, 6, 7, 'Uma longa ponte de madeira e pedra que conecta o castelo às torres'),
(6, 1, 'Torre leste', NULL, NULL, NULL, 5, 'Uma torre elevada com janelas estreitas, usada por estudiosos para observações astronômicas. A vista do topo oferece um panorama deslumbrante dos terrenos da escola.'),
(7, 1, 'Torre oeste', NULL, NULL, 5, NULL, 'A torre oeste, conhecida por ser o lar de corujas mensageiras, ecoa com o som suave de asas batendo durante a madrugada.'),
...
(9, 1, 'Ruinas antigas', NULL, NULL, 3, NULL, 'Vestígios misteriosos de uma era passada, situadas nos terrenos de Hogwarts, cercadas por vegetação rasteira e árvores centenárias.'),
...
(15, 1, 'Dormitório: Grifinória', NULL, NULL, NULL, 40, 'Um dormitório acolhedor com tapeçarias vermelhas e douradas, decorado com brasões da casa Grifinória. A lareira central mantém o local sempre aquecido.'),
(16, 1, 'Dormitório: Cornival', NULL, NULL, 39, NULL, 'Um dormitório elegante com detalhes em azul e prateado. O teto reflete o céu noturno, proporcionando uma visão das estrelas.'),
(17, 1, 'Dormitório: Sonserina', NULL, NULL, 40, NULL, 'Um dormitório subterrâneo com paredes de pedra e luzes verdes etéreas. A atmosfera é fria, mas repleta de mistério.'),
(18, 1, 'Dormitório: Lufa-lufa', NULL, NULL, NULL, 39, 'Um dormitório aconchegante com cores quentes e móveis de madeira. Plantas mágicas decoram o espaço, trazendo vida e serenidade.'),
